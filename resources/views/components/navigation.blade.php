<div class="relative overflow-hidden">
    <div class="max-w-screen-xl mx-auto">
      <div class="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-8">  
        <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
            ...
            <div class="hidden md:block md:ml-8 justify-end">
              <a href="{{ route('posts.index') }}" class="font-medium text-gray-300 hover:text-gray-500 transition duration-150 ease-in-out">The Blog</a>
              <a href="{{ route('posts.index') }}" class="ml-8 font-medium text-gray-300 hover:text-gray-500 transition duration-150 ease-in-out">Portfolio</a>
              <a href="{{ route('posts.index') }}" class="ml-8 font-medium text-gray-300 hover:text-gray-500 transition duration-150 ease-in-out">My Identites</a>
              <a href="{{ route('posts.index') }}" class="ml-8 font-medium text-gray-300 hover:text-gray-500 transition duration-150 ease-in-out">Scalemodel Stuff</a>
            </div>
          </nav>
        </div>
        ...
        <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div class="rounded-lg shadow-md">
            <div class="rounded-lg shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
